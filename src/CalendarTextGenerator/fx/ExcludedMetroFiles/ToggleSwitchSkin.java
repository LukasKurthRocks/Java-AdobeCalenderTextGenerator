package CalendarTextGenerator.fx.ExcludedMetroFiles;
...
public class ToggleSwitchSkin extends SkinBase<ToggleSwitch>{
    ...
    @Override protected double computeMinWidth(double height, double topInset, double rightInset, double bottomInset, double leftInset) {
        ...
        double textWidth = com.sun.javafx.scene.control.skin.Utils.computeTextWidth(font, labelText, 0);
    ...
    @Override protected double computeMinHeight(double width, double topInset, double rightInset, double bottomInset, double leftInset) {
        final Font font = label.getFont();
        final String labelText = label.getText();
        final double textHeight = com.sun.javafx.scene.control.skin.Utils.computeTextHeight(font, labelText, 0, label.getLineSpacing(), label.getBoundsType());
